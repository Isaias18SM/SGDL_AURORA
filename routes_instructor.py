...
def novedades():
    ...
    if request.method == 'POST':
        ...
        # --- Publicar circular (instructor o coordinador, como ya funcionaba) ---
        if accion == 'circular':
        ...
        # --- Enviar novedad al coordinador (SOLO instructor) ---
            ...
            # Verificación en servidor: aunque el formulario esté oculto para
            # el coordinador en el HTML, esto evita que llegue por POST directo.
